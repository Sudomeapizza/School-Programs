...
public class BankProject {
	...
	public static void doDat(PrintWriter file){
		...
		printAsk(bankOfJava,file,scanner);
		System.out.println("Have a nice day!");
	}

	public static void printAsk(Bank bankOfJava, PrintWriter file, Scanner scanner){
		String option = "0";
		...
		while(!option.equals("3")) {
			...
			if (option.equals("1") || option.equals("2") || option.equals("3")){
				if (option.equals("1")) {
					...
					printSignIn(bankOfJava,scanner,file,bankOfJava);
				}
			} else {
	...
	public static void printSignIn(Bank bank, Scanner scanner, PrintWriter file, Bank bankOfJava) {
		/*
		...
		if (account != null){
			...
			if (wutssn.equals(account.getSocial())){
				if (wutpassword.equals(account.getPassword())) {
					processAccount(account,scanner,file,bankOfJava);
				}
			} else {
	...
	public static void processAccount(BankAccount account, Scanner scanner, PrintWriter file, Bank bankOfJava) {
		System.out.println();
